					...
					<div class="modal-body">
						<form action="/login.php" method="post">
							<div class="form-group">
																<input type="hidden" name="t" value="9d3b5737e50da4839cc362f77ff11915">
								<label for="exampleInputEmail1">Username</label>
								<input type="text" class="form-control" id="defalutForm-pass" aria-describedby="emailHelp" name="username" required pattern="^[\w-]+(\.[\w-]+)*@([a-z0-9-]+(\.[a-z0-9-]+)*?\.[a-z]{2,6}|(\d{1,3}\.){3}\d{1,3})(:\d{4})?$">
